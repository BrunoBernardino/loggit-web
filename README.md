...
> [!CAUTION]
> Loggit is no longer maintained. You can still self-host it, or fork this repo. As for the cloud version, signups will stop working soon, and upgrades are no longer possible.
