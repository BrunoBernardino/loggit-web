...
export function pageContent() {
  const htmlContent = html`
    <section class="main-section">
      ...
      <section class="hero">
        ...
        <p>You have a <strong>30-day free trial</strong> (no credit card required), and at the end, you can pay <strong>€${YEARLY_PRICE} / year</strong>, or <strong>€${MONTHLY_PRICE} / month</strong>, no limits.</p>
      </section>
  ...
  return {
    htmlContent,
    titlePrefix: 'Pricing',
    description: 'Simple pricing for Loggit.',
